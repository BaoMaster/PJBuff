...
const ChatContainer: React.FC<ChatContainerProps> = ({ currentChat, currentUser, socket }) => {
  ...
  useEffect(() => {
    const getMsg = async () => {
      if (currentChat && currentUser) {
        const response = await ConfigSetting.getAllMessages(currentUser._id, currentChat._id);
  ...
  const handleSendMessage = async (msg: string, image: string) => {
    if (currentUser) {
      await ConfigSetting.sendMessage(currentUser._id, currentChat._id, msg, image);
